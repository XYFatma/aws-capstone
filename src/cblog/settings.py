...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/capstone-PS/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/capstone-PS/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.c1uwgi0i81cm.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'fatma-capstone-project' # please enter your s3 bucket name
